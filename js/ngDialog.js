				...
				var publicMethods = {
					...
					open: function (opts) {
						...
						$q.when(loadTemplate(options.template || options.templateUrl)).then(function (template) {
							...
							self.$result = $dialog = $el('<div id="ngdialog' + globalID + '" class="modal fade in"></div>');
							$dialog.html((options.overlay ?
								'<div class="modal-backdrop fade in"></div><div class="modal-dialog"><div class="modal-content">' + template + '</div></div>' :
								'<div class="modal-dialog"><div class="modal-content">' + template + '</div></div>'));
